...
<section class="mt-10 flex gap-10">
  <div class="w-2/3">
          ...
          <div>
            ...
            <div class="flex items-center gap-6 mt-3">
              <form method="post" action="basket.php?plant_id=<?= $plant->getId() ?>&action=remove">
                <button>
                  <i class="fa-solid fa-circle-minus text-blue-500 hover:text-blue-700 fa-2xl"></i>
                </button>
              </form>
              <form method="post" action="basket.php?plant_id=<?= $plant->getId() ?>&action=add">
                <button>
                  <i class="fa-solid fa-circle-plus text-blue-500 hover:text-blue-700 fa-2xl"></i>
                </button>
              </form>
            </div>
          </div>
    ...
    <?php endif ?>
    <br/>
    <a href="" class="ml-20 py-2 px-4 rounded bg-green-500 hover:bg-green-700 text-white">
    <i class="fa-solid fa-eye mr-2"></i>Passer Commande
  </a>
  </div>
  <div class="w-1/3"></div>
</section>
